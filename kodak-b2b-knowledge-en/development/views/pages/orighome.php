...
-->
<div style="font-size: 16px;    line-height: 20px; padding-bottom:15px;">Experience the wealth of commercial product expertise at Kodak.  Review recent content changes in the list below or <a href="/app/answers/list">start searching</a> the knowledgebase.</div>
                           <div class="rn_Module">
...
<div class="rn_ClearBoth">
                          <rn:widget path="reports/Grid2" report_id="#rn:php:$home_msg_base_array['whatsnewreport_id']#" per_page="20"/>
                          <div align="center"><rn:widget path="reports/Paginator" report_id="#rn:php:$home_msg_base_array['whatsnewreport_id']#" per_page="5" /></div>
                        </div>
</div>
