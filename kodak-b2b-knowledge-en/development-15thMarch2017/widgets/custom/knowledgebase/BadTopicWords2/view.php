<rn:meta controller_path="standard/knowledgebase/TopicWords2" js_path="custom/knowledgebase/TopicWords2" presentation_css="widgetCss/TopicWords2.css" compatibility_set="November '09+"/>
<?
           $cAccess = 0;
		   $ab = contact_answer_access();
