...
#rn_SideBar .rn_Padding {
	...
	<h2>Announcements</h2>
	    ...
	    <img style="margin-top:16px;" src="/euf/assets/themes/Kodak/images/layout/welcomeVault.jpg" />  
                    ...
                    <rn:condition show_on_pages="answers/detail" ><script>var arr = [], l = document.links;for(var i=0; i<l.length; i++) {  if   (l[i].href.indexOf("file=") > 0) {   //alert ('there is download manager link on this page');	   document.write('<p> <a target="_blank" href="/app/answers/detail/a_id/66996">Problems Downloading?</a></p>');	   break;  }}</script> 					
                    <div class="rn_Module">
