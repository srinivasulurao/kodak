...
* @access   public
*/
class nusoap_client2 extends nusoap_base  {
	...
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		if ($headers) {
			$this->requestHeaders = $headers;
                	    ...
                	    file_put_contents("/tmp/ee_service_order_WS.log",print_r('Before WSDL:',true),FILE_APPEND );
		if ($this->endpointType == 'wsdl' && is_null($this->wsdl)) {
			$this->loadWSDL();
			if ($this->getError())
				return false;
		}
file_put_contents("/tmp/ee_service_order_WS.log",print_r('After WSDL:',true),FILE_APPEND );
...
if (!extension_loaded('soap')) {
	 ...
	 */
	class soapclient extends nusoap_client2 {
	}
}
?>
