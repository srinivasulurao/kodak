<rn:meta title="#rn:msg:ERROR_LBL#" template="kodak_b2b_template.php" />
<?
switch(getUrlParm('error_id'))
{
    ...
    case 7:
        ...
        break;
    case 99:
        $errorTitle = 'Site for password reset only';
        $errorMessage = 'Please navigate to your correct site.';
        break;
    case 'sso9':
