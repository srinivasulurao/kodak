<rn:meta title="Knowledge Base" template="kodak_b2b_template.php" clickstream="answer_list" login_required="true"/>
        ...
        <div class="rn_HeroInner">
            <div class="rn_SearchControls">
                ...
                <form onsubmit="return false;">
                    ...
                    <rn:widget path="searchsource/SourceSearchButton"  history_source_id="KFSearch" report_page_url="/app/answers/list"/>
                

                <div class="rn_SearchFilters">
                    <rn:widget path="searchsource/SourceProductCategorySearchFilter" search_on_select="true" />
                    <rn:widget path="searchsource/SourceProductCategorySearchFilter" search_on_select="true" filter_type="Category"/>
                </div>
...
<rn:condition_else/>
    ...
    <div class="rn_Container">
        ...
        <aside class="rn_SideRail custom_contact_div" role="complementary"> 
        <h2 style="border-bottom: 1px solid lightgrey;padding-bottom: 10px;margin-bottom: 10px;">Contact Us</h2>
        <div>If you have any questions or comments about the CFS system, contact us at <a href='mailto:CPCDLCFSHelp@cpchem.com' style='text-transform: lowercase;'>CPCDLCFSHelp@cpchem.com</a></div>
        </aside>
