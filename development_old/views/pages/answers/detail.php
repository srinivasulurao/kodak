...
<div id="rn_PageContent" class="rn_AnswerDetail">
    ...
    <rn:widget path="custom/knowledgebase/MyRelatedAnswers" label_title="#rn:php:$templ_msg_base_array['lbl_related_manual']#" relatedlinksonly="true" limit="20" />
    ...
    <br/>
    <rn:widget path="custom/knowledgebase/MyRelatedAnswers"  label_title="#rn:php:$templ_msg_base_array['lbl_related_learned']#" relatedlinksonly="false" />
