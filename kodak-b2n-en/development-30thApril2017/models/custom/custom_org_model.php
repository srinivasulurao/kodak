...
initConnectAPI();
class custom_org_model extends \RightNow\Models\Base {
	...
	function getPartnerTypeList($org_id) {
		...
		if($org->CustomFields->ek_customer_sapid)		
			$partner_type_list[] = array('ID'=>$org->CustomFields->ek_customer_sapid,'Type'=>$ccih_lang_msg_base_array["direct"]);
		...
		$partner_type_list[] = array('ID'=>$org->CustomFields->ek_corporate,'Type'=>$ccih_lang_msg_base_array["corporate"]);
