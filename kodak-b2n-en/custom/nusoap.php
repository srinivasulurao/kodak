<?php
//Hao Dong - 3/15/11
//This is a customized version for Kodak_b2b Web Services. Do NOT use with other project
//Hard Code SSL Version
...
//		}
		...
		if ($this->scheme == 'https') {
			...
			//Hao Dong 3/15/2011 Add SSL VERSION
			/*$this->setCurlOption(CURLOPT_SSLVERSION, 3);
...
// Set to updated CA bundle
$this->certRequest['cainfofile'] = "/vhosts/kodak_b2b_en/euf/assets/cacert.pem";
