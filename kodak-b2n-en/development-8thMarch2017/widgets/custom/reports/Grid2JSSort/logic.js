...
RightNow.Widget.Grid2JSSort = function(data, instanceID){
    this.data = data;
    ...
    RightNowEvent.subscribe("evt_reportResponse" , this._onReportChanged, this);
    RightNowEvent.subscribe("evt_searchInProgressResponse", this._searchInProgress, this);
    RightNowEvent.subscribe("evt_getFiltersRequest", this._onGetFiltersRequest, this);
    RightNowEvent.subscribe("evt_sortTypeResponse", this._onSortTypeResponse, this);
    this._setFilter();
    RightNowEvent.fire("evt_setInitialFiltersRequest", this._eo);
    ...
    if (RightNowEvent.isHistoryManagerFragment()) {
...
RightNow.Widget.Grid2JSSort.prototype = {
    /**
    ...
    */
     ...
     _generateYUITable: function(source, dest, headers)
    {
        ...
        //2012.10.04 scott harris: added the undefined check below
        ...
        //2012.10.04 scott harris: commented out to remove bug potential returning too much data b/c of filters
    ...
    */
     ...
     * @private
     * @param text String The text to update the div with
     */
