        ...
        if (!result) {
           ...
           alert("No Results Found.");
            ...
            var siteColumnDefs = [
                ...
                {key:"manage",label:this.data.js.mysites_action, minWidth:140, sortable:false, formatter:this._getActionLinks()}
            ...
            component = new Array();
               ...
               /* GGG var subDataSource = new YAHOO.util.DataSource(aProduct);
                ...
                var subColumnDefs = [
                  ...
                  {key:"svcDelivery",label:this.data.js.pid_action, minWidth:140, sortable:false, formatter:"ibaseCustom"}
