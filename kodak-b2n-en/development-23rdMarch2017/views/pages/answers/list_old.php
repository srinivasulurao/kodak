...
<rn:widget path="search/ProductCategorySearchFilter" filter_type="products" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#" label_input="" label_nothing_selected="All Products"  search_on_select="true" linking_off="true" />
<br />
<b><? echo $browse_msg_base_array['category_lbl']; ?></b><br />
<rn:widget path="search/ProductCategorySearchFilter" filter_type="categories" label_input="" label_nothing_selected="All Categories" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#" search_on_select="true" linking_off="true" />
</td>
...
<div style="float:right; padding: 25px 80px 0px 0px;">                            <a class="rn_SearchLink"  href="javascript:void(0);" onclick="window.open('/app/utils/help_search', '', 'scrollbars,resizable,width=720,height=700'); return false;">#rn:msg:SEARCH_TIPS_LBL#</a></div>
                ...
                <rn:widget path="standard/search/SearchButton" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#"/>
            </form>
...
<!--        <rn:widget path="reports/SearchTruncation" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#"/>-->
