<rn:meta title="#rn:msg:CHANGE_YOUR_PASSWORD_CMD#" template="kodak_b2b_template.php" login_required="true"/>
...
<div id="rn_PageContent" class="rn_Account">
    <div class="rn_Padding">
        ...
        <form id="rn_ChangePassword" method="post" action="" onsubmit="return false;">
            ...
            <rn:widget path="input/PasswordInput" name="Contact.NewPassword"
