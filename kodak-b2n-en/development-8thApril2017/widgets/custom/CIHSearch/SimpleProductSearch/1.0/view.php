...
<div class="rn_Accordion_container">
  ...
  <div id="rn_<?=$this->instanceID;?>_containerDetails" class="rn_FormPanel99">
    ...
    <div id="panelDetails" style="width=100%;">
      ...
      <ul class="yui-nav">
		  <li class="selected pid_tabs comp_first_tab" display_content='div_contracts'><a  href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_entitlement']; ?></em></a></li>
          <li class="pid_tabs" display_content='equipment_site_info'><a href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_siteinformation']; ?></em></a></li>
          <li class="pid_tabs" display_content='contract_payer_info'><a href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_servicecontractpayerinfo']; ?></em></a></li>
          <li class="pid_tabs" display_content='meters_div' ><a href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_meterview']; ?></em></a></li>
