    ...
    */
    ...
    _onSelectChange: function (evt, args) {
        ...
        if(this._optionsSelect!=null){
			...
			/* this._eo.data.expandlist = new Array('accordionManageContacts2');
			this._eo.data.showlist = new Array('accordionManageContacts2');
			this._eo.data.hidelist = new Array('accordionIbaseUpdate2','accordionRepairRequest2');
			
			RightNow.Event.fire('evt_managePanel', this._onManagePanel, this._eo); */
			
			//RightNow.Event.fire('evt_contactDropDownChanged',this._eo);
			}
