...
?>
		...
		<div id="rn_<?=$this->instanceID;?>_container" class="rn_FormPanel">
			...
			<form id="rn_<?=$this->instanceID;?>_form" onsubmit="return false" method='post' action="/cc/contact_custom/contact_update_submit">
