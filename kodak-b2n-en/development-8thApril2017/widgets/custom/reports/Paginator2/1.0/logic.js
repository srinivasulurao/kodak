...
Custom.Widgets.reports.Paginator2 = RightNow.Widgets.Paginator.extend({ 
    ...
    overrides: {
        ...
        constructor: function() {
            ...
            this.parent();  
            this._eo.filters.per_page=(this._eo.filters.page==1)?parseInt(this.data.attrs.per_page+1):this.data.attrs.per_page;
        ...
        newData.total_pages=Math.ceil(parseFloat(parseInt(newData.total_num)/parseInt(newData.per_page)));
