...
$data ="cF91c2VyaWQ9dHJhdmlzLmNhYmxlX1JudCZwX2VtYWlsLmFkZHI9dHJhdmlzLmNhYmxlQG9yYWNsZS5jb20mcF9uYW1lLmZpcnN0PVRyYXZpcyZwX25hbWUubGFzdD1DYWJsZSZwX3Bhc3N3ZD0mcF9saV9wYXNzd2Q9fkVlRVooVG86cw==";
$data=base64_decode($data);
$data=parse_str($data,$output);

$login=($_REQUEST['login'])?$_REQUEST['login']:$output['p_userid'];
	...
	public function mypre_report_get(&$arr)
	{
		...
		//print_r($arr);
            if(!$arr['data']['filters']['org'])
            {
                ...
                $partner_type_list = $this->CI->model("custom/custom_org_model")->getPartnerTypeList($this->CI->session->getProfileData('org_id'));
