...
Custom.Widgets.output.CurrentMeter = RightNow.Widgets.extend({ 
    ...
    constructor: function() {
     ...
     _displayData: function (evt, args) {
		...
		if(document.querySelectorAll('#div_meters2 .yui3-datatable-data tr').length)
		   this.Y.all("#div_meters2 .yui3-datatable-data tr").on("click",this._sendMeterUpdate,this,current_meter_table);
    ...
    _sendMeterUpdate: function (evt, eo) {
		...
		var trs=document.querySelectorAll("div_meters2 .yui3-datatable-data tr");
				var rowIndex=0;
        ...
        mypostData['sapid'] = oRecord.SAPID.value;
