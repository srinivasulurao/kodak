...
//        this.on('response', this._onSearchResponse, this);
     ...
     _startSearch: function (evt) {
        ...
        this.fire("collect", this._eo);
        RightNow.Event.fire("evt_formFieldValidateRequest", this._eo);
         this.fire("collect", this._eo);
