...
<div class="rn_Accordion_container">
  ...
  <rn:widget path="CIHFunction/Accordion" name="accordionProducts" visible="false" expanded="false" item_to_toggle="panelProducts" label_header="#rn:php:$cih_lang_msg_base_array['prodidentifier']#" />
...
<div class="rn_Accordion_container rn_Hidden">
  ...
  <div id="rn_<?=$this->instanceID;?>_containerDetails" class="rn_FormPanel99">
    ...
    <div id="panelDetails" style="width=100%;">
      ...
      <ul class="yui-nav">
		  <li class="pid_tabs comp_tab" display_content='div_contracts'><a  href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_entitlement']; ?></em></a></li>
          <li class="pid_tabs comp_tab" display_content='equipment_site_info'><a href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_siteinformation']; ?></em></a></li>
          <li class="pid_tabs comp_tab" display_content='contract_payer_info'><a href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_servicecontractpayerinfo']; ?></em></a></li>
          <li class="pid_tabs comp_tab" display_content='meters_div' ><a href="javascript:void(0)"><em><? echo $cih_lang_msg_base_array['pidtab_meterview']; ?></em></a></li>

      </ul>            
      <div class="yui-content">
        <div id="div_contracts" style='display:block'></div>
		...
		<span id='meters_div'>
          <table id="meters" name="meters">
           ...
           <tr><td>
             <div class="rn_Accordion_container">
               <rn:widget path="CIHFunction/Accordion" name="accordionMeterHistory" visible="true" expanded="false" item_to_toggle="panelMeterHistory" label_header="#rn:php:$cih_lang_msg_base_array['pidmeterhistory']#" />
...
<div class="rn_Accordion_container rn_Hidden">
  <rn:widget path="CIHFunction/Accordion" name="accordionManageContacts" visible="false" expanded="false" item_to_toggle="panelManageContacts" label_header="#rn:php:$cih_lang_msg_base_array['managecontacts']#" />
...
<div class="rn_Accordion_container rn_Hidden">
  <rn:widget path="CIHFunction/Accordion" name="accordionRepairRequest" visible="false" expanded="false" item_to_toggle="panelRepairRequest" label_header="#rn:php:$cih_lang_msg_base_array['repairrequest']#" />
...
<div class="rn_Accordion_container rn_Hidden">
  <rn:widget path="CIHFunction/Accordion" name="accordionIbaseUpdate" visible="false" expanded="false" item_to_toggle="panelIbaseUpdate" label_header="#rn:php:$cih_lang_msg_base_array['ibaseupdate']#" />
...
<input type="hidden" id="sample_json" value='{"0":{"Site":[{"OrgName":"BOOKLET BINDING INC","street":"710 KIMBERLY DR","city":"CAROL STREAM"
...
:"573099"}]},"status":1,"Site":[{"OrgName":"BOOKLET BINDING INC","street":"710 KIMBERLY DR","city":"CAROL STREAM"
,"zip":"60188","province":"Illinois-IL","country":"US","custSAPId":"600000","orgID":347075,"manage":"Manage
 Contacts","ibaseID":"1881722","name":"BOOKLET BINDING INC","partnerfunction":"2","partnerID":null,"customerID"
:"600000"},{"OrgName":"Softco Ltd","street":"South County Business Park","city":"LEOPARDSTOWN, IRELAND"
,"zip":"DUBLIN 18","province":null,"country":"IE","custSAPId":"591986","orgID":1415,"manage":"Manage
...
,"partnerID":null,"customerID":"905753"},{"OrgName":"Williams Lea","street":"Lomond View","city":"CRAIGFORTH
  STIRLING","zip":"FK9 4SH","province":null,"country":"GB","custSAPId":"573099","orgID":29291,"manage"
:"Manage Contacts","ibaseID":"55843","name":"Williams Lea","partnerfunction":"2","partnerID":null,"customerID"
:"573099"}],"Payer":{"OrgName":null,"street"
