...
<rn:meta title="Service Request Actions Taken" template="kodak_b2b_template.php" login_required="true" clickstream="incident_view"/>
    ...
    <div class="rn_Padding">
		...
		<div class="rn_Accordion_container">
			...
			<div id="panelContent" style="padding:10px;">
				...
				<rn:widget path="reports/Grid"  report_id="100823"/>
			</div>
		</div>
		...
		<div  class="rn_Accordion_container">
			...
			<div id="pnlActions" style="padding:10px;">	
				...
				<div id="rn_QuestionThread">
					<rn:widget path="reports/Grid"  report_id="100821"/>					
				</div>
		
				<h2 class="rn_HeadingBar">Parts</h2>
				<div id="rn_QuestionThread">
					<rn:widget path="reports/Grid"  report_id="100822"/>
				</div>
		
				<h2 class="rn_HeadingBar">Description</h2>
				<div id="rn_QuestionThread">
					<rn:widget path="reports/Grid"  report_id="100820"/>
				</div>
			</div>
