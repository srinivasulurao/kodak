...
//if ($this->_form['sesslang'] == "fr") { $tcih_lang_msg_base_array=load_array("csv_cih_french_strings.php");  }
//else $tcih_lang_msg_base_array=load_array("csv_cih_english_strings.php");
		switch ($this->_form['sesslang']) {
        case "en":
