...
?>
<rn:meta title="Service Request Activity Details" template="kodak_b2b_template_fullwidth.php" login_required="true" clickstream="incident_view"/>
    ...
    <div class="rn_Padding">
		<div class="rn_Accordion_container">
			...
			<div id="pnlDetails" style="padding:10px;">
				...
				<div id="rn_AdditionalInfo">
					<rn:widget path="custom/reports/Grid2JSSort"  report_id="100819"/>
				</div>
			</div>
		</div>
		...
		<div class="rn_Accordion_container">
			...
			<div id="pnlEvents" style="padding:10px;">
				<div id="rn_AdditionalInfo">
					<rn:widget path="custom/reports/Grid2JSSort"  report_id="100903" url_column="2" url_text="View Details"/>
 				</div>
			</div>
		</div>
		<? endif;?>
