		...
		<div class="quicksearch">#rn:msg:QUICK_SEARCH_CMD#</div>
            ...
            <form method="post" action="" onsubmit="return false" >
                ...
                <div class="rn_SearchInput">
                    <rn:widget path="custom/search/AdvancedSearchDialog" report_page_url="/app/answers/list" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#" display_categories_filter="false" display_products_filter="false"/>  
...
<?php
$templ_msg_base_array['portal_report_id']
?>
</div>
