RightNow.Widget.OpenLogin = function(data, instanceID){
    this.data = data;
...
RightNow.Widget.OpenLogin.prototype = {
    /**
...
//            anim.animate();   
    ...
    */
    _setAriaSelected: function(selectedElement){
        ...
        Dom.setAttribute(selectedElement, 'aria-selected', 'true');
    },
