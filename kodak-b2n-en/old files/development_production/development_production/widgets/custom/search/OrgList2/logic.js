...
RightNow.Widget.OrgList2 = function (data, instanceID) {
    this.data = data;
    ...
    RightNowEvent.subscribe("evt_orgTypeResponse", this._onChangedResponse, this);
...
RightNow.Widget.OrgList2.prototype = {
