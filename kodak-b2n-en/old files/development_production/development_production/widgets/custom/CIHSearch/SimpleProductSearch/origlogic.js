       ...
       // First check for errors
        ...
        if (!result) {
           ...
           alert("No Results Found.");
            ...
            var siteColumnDefs = [
                {key:"custSAPId",label:"Site Customer ID", sortable:false},
                {key:"OrgName",label:"Name", sortable:false},
                {key:"street",label:"Street", sortable:false},
                {key:"city",label:"City", sortable:false},
                {key:"zip",label:"Postal Code", sortable:false},
                {key:"province",label:"Province", sortable:false},
                {key:"country",label:"Country", sortable:false},
                {key:"manage",label:"Action", minWidth:140, sortable:false, formatter:"myCustom"}
              ];
...
/*
       ...
       productDataSource.responseSchema = {
            ...
            var productColumnDefs = [
                {key:"ID",label:"Product Identifier", sortable:false},
                {key:"SN",label:"Serial Num", sortable:false},
                {key:"Name",label:"Product Description", sortable:false},
                {key:"plan",label:"Entitlement", sortable:false},
                {key:"planStart",label:"Contract Start", sortable:false},
                {key:"planEnd",label:"Contract End", sortable:false},
                {key:"repair",label:"Action", minWidth:140, sortable:false, formatter:"repairCustom"}
             ];
             ...
             this.productDataTable.subscribe("linkClickEvent", function(oArgs) {
              ...
              //var myProductHandler = function(oArgs) {
               ...
               var ibaseCustomFormatter = function(elCell, oRecord, oColumn, oData) {
                   elCell.innerHTML = "<a class=\"actionlink\" id=\"lnkIbaseUpdateComponent\">Ibase Update</a>";
               };
               ...
               YAHOO.widget.DataTable.Formatter.ibaseCustom = ibaseCustomFormatter;
                ...
                var subColumnDefs = [
                  ...
                  {key:"planStart",label:"Contract Start", sortable:false},
                  {key:"planEnd",label:"Contract End", sortable:false},
                  {key:"",label:"Action", minWidth:140, sortable:false, formatter:"ibaseCustom"}
                ];
...
/* for the mainframe we also need to show its contracts and site info */                       
                 ...
                 //clear data from contracts table
                  ...
                  {key:"description",label:"Product", sortable:false},
                  {key:"serviceProfileDesc",label:"Coverage Time", sortable:false},
                  {key:"responseProfileDesc",label:"Prioritized Response", sortable:false},
                  {key:"startDate",label:"Contract Start", sortable:false},
                  {key:"endDate",label:"Contract End", sortable:false},
                  {key:"type",label:"Contract Type", sortable:false},
                  {key:"status",label:"Contract Status", sortable:false},
                  {key:"contractID",label:"Contract ID", sortable:false}
                  ];
                  ...
                  aCell.innerHTML = "Kodak Customer #:";
                  ...
                  aCell.innerHTML = "Customer Name:";
                  bCell.innerHTML = arr['Payer'].OrgName;

                  pRow = tblPayer.insertRow(-1);
                  aCell = pRow.insertCell(-1);
                  bCell = pRow.insertCell(-1);
                  aCell.innerHTML = "Address:";
                  ...
                  if(mfProduct[0] != null) {
                    ...
                    cCell.innerHTML = "Floor / Building:";
                    dCell.innerHTML = mfProduct[0].floorBldg;

                    var eRow = tblEquipmentSite.insertRow(-1);
                    var cCell = eRow.insertCell(-1);
                    var dCell = eRow.insertCell(-1);
                    cCell.innerHTML = "Entrace Door:";
                    dCell.innerHTML = mfProduct[0].door;

                    var eRow = tblEquipmentSite.insertRow(-1);
                    var cCell = eRow.insertCell(-1);
                    var dCell = eRow.insertCell(-1);
                    cCell.innerHTML = "Additional Address:";
  ...
  _getActionLinks : function(type) {
    ...
    if(this.allowRepairRequest && type == "RepairRequest")
      htmlRepair = "<a id=\"lnkRepairRequest\" class=\"actionlink\">Repair Request</a>";

    if(this.allowIbaseUpdate && type == "IbaseUpdate")
      htmlUpdate = "<a id=\"lnkIbaseUpdate\" class=\"actionlink\">Ibase Update</a>&nbsp;&nbsp;";
  ...
  _getManageLink : function() {
    ...
    if (partnerType != null) {
      ...
      if (this.allowManageContact && partnerIDValue == "Direct") {
        htmlManage = "<a class=\"actionlink\" id=\"lnkManageContacts\">Manage Contacts</a>";
      }
