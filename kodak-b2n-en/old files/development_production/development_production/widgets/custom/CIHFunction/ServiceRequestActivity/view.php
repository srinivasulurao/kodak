...
<div class="rn_Accordion_container">
  <rn:widget path="CIHFunction/Accordion" expanded="true" item_to_toggle="panelSearchFilters" label_header="#rn:php:$cih_lang_msg_base_array['searchfilters']#" />
...
<div class="rn_Accordion_container">
  <rn:widget path="CIHFunction/Accordion" expanded="true" item_to_toggle="panelServiceRequests" label_header="#rn:php:$cih_lang_msg_base_array['sra_servicerequests']#" />
  <div id="rn_<?=$this->instanceID;?>_containerServiceRequests" class="rn_FormPanel">
    <div id="panelServiceRequests" class="rn_Accordion_content" style="pading:10px;">
		...
		<rn:widget path="custom/reports/Paginator" report_id="#rn:php:$cih_lang_msg_base_array['sra_repideksupporthistory']#" label_forward="#rn:php:$cih_lang_msg_base_array['next']#" label_back="#rn:php:$cih_lang_msg_base_array['previous']#" />  
		</div>
	</div>
  </div>	
</div>
