...
<rn:meta controller_path="custom/CIHFunction/ProdCatSelection" js_path="custom/CIHFunction/ProdCatSelection" base_css="custom/CIHFunction/ProdCatSelection" presentation_css="widgetCss/ProductCategoryInput.css" compatibility_set="November '09+"/>
...
<div id="rn_<?=$this->instanceID;?>" class="rn_ProductCategoryInput" style="<?=$this->data['attrs']['vis'];?>" >
    ...
    <span class="rn_Label">
        ...
        <span id="rn_<?=$this->instanceID;?>_RequiredLabel" class="rn_RequiredLabel">
