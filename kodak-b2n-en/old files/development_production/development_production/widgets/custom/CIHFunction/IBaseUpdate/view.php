<rn:meta controller_path="custom/CIHFunction/IBaseUpdate" js_path="custom/CIHFunction/IBaseUpdate" base_css="custom/CIHFunction/IBaseUpdate" presentation_css="widgetCss/FormPanel.css"/>
<?
                                                ...
                                                <table cellspacing="2" >
                                                        <tr>
                                                                <td>
                                                                  ...
                                                                  <div class="rn_Hidden">
                                                                    <rn:widget path="standard/input/FormInput" name="incidents.c$orig_submit_id" default_value="#rn:php:$contact->c_id->value#" required="true" readonly="true"/>
                                                                    <rn:widget path="standard/input/FormInput" name="incidents.c$orig_submit_name" default_value="#rn:php:$contact->full_name->value#" required="true" readonly="true"/>
                                                                  </div>
