RightNow.Widget.ContactSelect = function (data, instanceID) {
    this.data = data;
...
RightNow.Widget.ContactSelect.prototype = {
    ...
    **/
    _getContacts: function (evt, args) {
        ...
        if (this.data.attrs.include_deactivated == false)
            deactivated = 'false';
        var postData = { 'deactivated': deactivated, 'org_id': this._currentOrgID };
    ...
    _ajaxResponse: function (args) {
        ...
        if (!result) {
            ...
            */
            ...
            option.text = this.data.attrs.no_selection_label;
            option.value = "0";
            this._optionsSelect.appendChild(option);
            this._optionsSelect.options[0].text = this.data.attrs.no_selection_label;
            var optionCount = 1;
