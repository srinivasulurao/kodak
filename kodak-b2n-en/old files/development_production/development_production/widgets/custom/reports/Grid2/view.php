...
<rn:meta controller_path="custom/reports/Grid2" js_path="custom/reports/Grid2" presentation_css="widgetCss/Grid2.css" base_css="custom/reports/Grid2" compatibility_set="November '09+"/>
