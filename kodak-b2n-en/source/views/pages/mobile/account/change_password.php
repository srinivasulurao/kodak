...
<section id="rn_PageContent" class="rn_Account">
    <div class="rn_Padding">
        ...
        <form id="rn_ChangePassword" onsubmit="return false;">
            <rn:widget path="input/FormInput" name="Contact.NewPassword" require_validation="true" require_current_password="true" label_input="#rn:msg:PASSWORD_LBL#" label_validation="#rn:msg:VERIFY_PASSWD_LBL#" initial_focus="true"/>
