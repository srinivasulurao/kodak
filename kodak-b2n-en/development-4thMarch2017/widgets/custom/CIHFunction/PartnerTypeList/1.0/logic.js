RightNow.namespace('Custom.Widgets.CIHFunction.PartnerTypeList');
Custom.Widgets.CIHFunction.PartnerTypeList = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */
    constructor: function(data, instanceID) {
		...
		if(document.getElementById(optionsName)!=null)
