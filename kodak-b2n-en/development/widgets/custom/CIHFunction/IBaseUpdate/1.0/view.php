                                                        ...
                                                        <tr>
                                                                ...
                                                                <td>
                                                                  ...
                                                                  <div class="rn_Hidden">
																	...
																	<rn:widget path="custom/CIHFunction/CheckBox" name="orig_submit_id" checked="true" value="#rn:php:$contact_id#" required="true" />


                                                                    <rn:widget path="custom/CIHFunction/CheckBox" name="orig_submit_name" checked="true" value="#rn:php:$contact_full_name#" required="true" />
                                                                ...
                                                                <td nowrap="nowrap" valign="bottom">
                                                                        ...
                                                                        &nbsp;&nbsp;<rn:widget path="custom/CIHFunction/CheckBox" name="secondarycontact" value="1" checked="true" help_text="If you would like to receive email updates when this incident is open and closed, please check this box." /><span><? echo $cih_lang_msg_base_array['cd_checkemailnotif']; ?></span>
