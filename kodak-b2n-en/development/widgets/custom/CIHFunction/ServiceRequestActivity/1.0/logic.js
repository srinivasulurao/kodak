...
Custom.Widgets.CIHFunction.ServiceRequestActivity = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */
    ...
    {
       // console.log(this.Y.one("body"));
        console.log("_searchRequest from Servicerequestactivity");
        this.Y.one("#searchResultsContainer").removeClass('rn_Hidden');
    },
    ...
    _partnerTypeChanged: function (evt, args) {
        ...
        console.log("_partnerTypeChanged from Servicerequestactivity");
