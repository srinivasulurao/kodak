...
Custom.Widgets.CIHFunction.PartnerTypeListSearch = RightNow.Widgets.extend({ 
    /**
     * Widget constructor.
     */
    ...
    _onSelectChange: function (evt) {
        console.log("PartnerTypeListSearch  _onSelectChange");
        this._setSelected();
    ...
    onValidate: function (type, args) {
        console.log("PartnerTypeListSearch  onValidate");
    ...
    _displayError: function (errorMessage) {
     ...
     _onResetForm: function (evt, args) {
         console.log("PartnerTypeListSearch  onResetForm");
    ...
    _onGetFiltersRequest: function (type, args) {
        console.log("PartnerTypeListSearch  ongetfilterRequest");
        this._setFilter();
    ...
    _ajaxIntercept: function (evt, args) {
        ...
        console.log("PartnerTypeListSearch  _ajaxIntercept");
