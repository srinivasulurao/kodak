<rn:meta title="#rn:msg:ERROR_LBL#" template="newkodak_b2b_template.php" />
<?
...
//        $errorMessage = getMessage(NO_ACCESS_PERMISSION_MSG);
		$errorMessage = 'If you have a Kodak Partner Place account, please log in to the <a href="https://partnerplace.kodak.com/login.html">Partner Place portal</a> to access all content that is available to you on My Kodak Services.';
        break;
    case 5:
