<rn:meta title="#rn:msg:SHP_TITLE_HDG#" template="newkodak_b2b_template.php" clickstream="home"/>
...
<div class="rn_Module">
	...
	<div style="float:left;margin-bottom:2px;">
		<rn:widget path="search/ProductCategorySearchFilter1" linking_off='true' search_on_select="true" report_id="#rn:php:$home_msg_base_array['whatsnewreport_id']#" label_input="" />
	</div>
	<rn:widget path="search/ProductCategorySearchFilter1" linking_off='true' report_id="#rn:php:$home_msg_base_array['whatsnewreport_id']#" label_input="" filter_type="categories" search_on_select="true" label_nothing_selected="#rn:msg:SELECT_A_CATEGORY_LBL#"  /> 
...
<div class="rn_Module">
	...
	<div style="margin-left:3px;margin-top:6px;float:left;margin-bottom:10px;">&nbsp;&nbsp;<? echo $home_msg_base_array['filterlistby']; ?></div>
	<div style="float:left;margin-bottom:2px;">
		<rn:widget path="search/ProductCategorySearchFilter" linking_off='true' search_on_select="true" report_id="#rn:php:$home_msg_base_array['mostpopularreport_id']#" label_input="" />
	</div>
	<rn:widget path="search/ProductCategorySearchFilter" linking_off='true' search_on_select="true" report_id="#rn:php:$home_msg_base_array['mostpopularreport_id']#" label_input="" filter_type="categories" search_on_select="true" label_nothing_selected="#rn:msg:SELECT_A_CATEGORY_LBL#"  />
