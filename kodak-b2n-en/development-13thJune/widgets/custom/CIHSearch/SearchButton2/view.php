...
<rn:meta controller_path="custom/CIHSearch/SearchButton2" 
         js_path="custom/CIHSearch/SearchButton2" 
...
<div id="rn_<?=$this->instanceID;?>" class="rn_SearchButton2">
    <? if ($this->data['attrs']['icon_path']):?>
        <input type="image" class="rn_SubmitImage" id="rn_<?=$this->instanceID;?>_SubmitButton" <?=tabIndex($this->data['attrs']['tabindex'], 1);?> src="<?=$this->data['attrs']['icon_path'];?>" alt="<?=$this->data['attrs']['icon_alt_text'];?>" title="<? echo $cih_lang_msg_base_array['search']; ?>"/>
    <? else:?>
<input type="submit" class="rn_SubmitButton" name="rnServiceRequestSearchButton" id="rn_<?=$this->instanceID;?>_SubmitButton" <?=tabIndex($this->data['attrs']['tabindex'], 1);?> value="<? echo $cih_lang_msg_base_array['search']; ?>" />
    <? endif;?>
    <? if($this->data['isIE']): ?>
