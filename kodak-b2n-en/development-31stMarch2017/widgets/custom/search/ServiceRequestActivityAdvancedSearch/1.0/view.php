	...
	<table id="advancedSearch" class="rn_serviceRequestAdvancedSearch_table">
		<tr>
			...
			<td valign="top">
				...
				<rn:widget path="standard/input/TextInput" name="ref_no" is_search_filter="true" search_filter_id="2" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />	
			</td>
			<td valign="top">
				<span><? echo $cih_lang_msg_base_array['sra_partnertrackingnum']; ?></span><br/>
				<rn:widget path="standard/input/TextInput" name="ek_ext_ref_no" is_search_filter="true" search_filter_id="7" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />
			</td>
		</tr>
		<tr>
			<td nowrap="nowrap" valign="top">
				<span><? echo $cih_lang_msg_base_array['sra_productidentifier']; ?></span><br/>
				<rn:widget path="standard/input/TextInput" name="ek_k_number" is_search_filter="true" search_filter_id="6" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />
			</td>
			<td nowrap="nowrap" valign="top">
				<span><? echo $cih_lang_msg_base_array['sra_serialnum']; ?></span><br/>
				<rn:widget path="standard/input/TextInput" name="ek_serial_number" is_search_filter="true" search_filter_id="8" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />
			</td>
<? if($this->data['js']['internal_user']=='N'): ?>
			<td nowrap="nowrap" valign="top">
				<span><? echo $cih_lang_msg_base_array['sra_sitecustid']; ?></span><br/>
				<rn:widget path="standard/input/TextInput" name="ek_customer_sapid" is_search_filter="true" search_filter_id="19" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />
			</td>
			<td valign="top">
				<?
...
<? if($this->data['js']['internal_user']=='Y'): ?>
			<td nowrap="nowrap" valign="top" colspan="2">
				<span><? echo $cih_lang_msg_base_array['sra_sitecustid']; ?></span><br/>
				<rn:widget path="standard/input/TextInput" name="ek_customer_sapid" is_search_filter="true" search_filter_id="19" label_required="#rn:php:$cih_lang_msg_base_array['sra_custidisrequired']#" required="true" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />
				<rn:widget path="standard/input/TextInput" name="ek_customer_sapid" is_search_filter="true" search_filter_id="19" label_required="#rn:php:$cih_lang_msg_base_array['sra_custidisrequired']#" required="true" search_operator_id="1" search_report_id="#rn:php:$this->data['attrs']['report_id']#" />
