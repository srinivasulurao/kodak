...
Custom.Widgets.CIHFunction.ServiceRequestActivity = RightNow.ResultsDisplay.extend({ 
    /**
     * Widget constructor.
     */
    overrides:
    ...
    constructor: function(data,instanceID) {
        ...
        this._searchResul1tsContainer = document.getElementById("searchResultsContainer");
