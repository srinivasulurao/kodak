...
Custom.Widgets.CIHSearch.CustomerSearch = RightNow.Widgets.extend({
    ...
    this.Y.all("#"+this._advanceSearchPanelTrigger.id).on("click", this._toggleAdvanceSearchPanel,this);
    ...
    */
    ...
    YUI().use('datatable', function (Y) {
		...
		if(document.querySelectorAll('#panelProducts2 .yui3-datatable-data tr').length){
		   ...
		   this.Y.all("#panelProducts2 .yui3-datatable-data .actionlink").on("click",this._selectIBase,this,product_table);
		}
    },
 ...
 */
       ...
       // bCell.innerHTML = arguments[0]['Payer'].SAPID;
		...
		if(document.querySelectorAll('#panelComponent2 .yui3-datatable-data tr').length)
           this.Y.all("#panelComponent2 .yui3-datatable-data tr").on("click",this._myComponentHandler,arguments[0],this);
