		...
		<table style="width:100%">
			<tr>
				...
				<td valign="bottom" align="right" width="425px" style="margin-right:200px;">
					...
					<rn:widget path="custom/search/SearchRequestActivitySearchButton" internal_user="#rn:php:$this->data['js']['internal_user']#" label="Search" report_id="#rn:php:$cih_lang_msg_base_array['sra_repideksupporthistory']#" />
				</td>				
			</tr>
			<tr>
				<td colspan="4">
