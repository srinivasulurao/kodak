    ...
    <div class="rn_Padding">
		<div class="rn_Accordion_container">
			...
			<div id="pnlDetails" style="padding:10px;">
				...
				<div id="rn_AdditionalInfo">
					<rn:widget path="reports/Grid"  report_id="100819"/>
				</div>
			</div>
		</div>
		...
		<div class="rn_Accordion_container">
			...
			<div id="pnlEvents" style="padding:10px;">
				<div id="rn_AdditionalInfo">
					<rn:widget path="reports/Grid"  report_id="100903" url_column="2" url_text="View Details"/>
 				</div>
			</div>
		</div>
		<? endif;?>
		...
		<div class="rn_Accordion_container">
			...
			<div id="pnlCommunication">
				...
				<? else:?>
						...
						<rn:widget path="input/TextInput" name="Incidents.Threads" value="" width="100%" height="150px" required="true" label_input="Additional information" />
