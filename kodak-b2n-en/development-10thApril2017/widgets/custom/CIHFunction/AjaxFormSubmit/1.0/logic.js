					...
					if(eo[0].url=="/cc/incident_custom/incident_submit"){
							...
							for(i=0;i<fields.length;i++){
								...
								if(document.querySelectorAll('#panelIbaseUpdate2 [name="'+fields[i]+'"]').length){
									...
									for(j=0;j < document.querySelectorAll('#panelIbaseUpdate2 [name="'+fields[i]+'"]').length;j++){
										
										if(document.querySelectorAll('#panelIbaseUpdate2 [name="'+fields[i]+'"]')[j].disabled==false){
											val=document.querySelectorAll('#panelIbaseUpdate2 [name="'+fields[i]+'"]')[j].value;
