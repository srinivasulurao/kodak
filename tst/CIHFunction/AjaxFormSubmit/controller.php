...
class AjaxFormSubmit extends Widget
{
    function __construct()
    {
        parent::__construct();
        $this->attrs['ajax_method'] = new Attribute('Ajax Method', 'STRING', 'Ajax Method', 'ajaxCustom/sendForm');
        $this->attrs['disable_result_handler'] = new Attribute('Disable Result Handler', 'BOOL', 'Disable Result Handler', false);
    ...
    function getData()
    {
        ...
        // Do not remove.
        $this->data['js']['f_tok'] = cpCreateTokenExp(0, $this->data['attrs']['challenge_required']);
        ...
        $this->data['js']['submitmsg'] = $ccih_lang_msg_base_array['submitting'];
