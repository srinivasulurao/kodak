<rn:meta controller_path="custom/CIHFunction/RoleSelect" js_path="custom/CIHFunction/RoleSelect" presentation_css="widgetCss/RoleSelect.css" compatibility_set="November '09+"/>
