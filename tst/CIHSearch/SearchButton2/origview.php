...
<div id="rn_<?=$this->instanceID;?>" class="rn_SearchButton2">
    ...
    <? else:?>
<input type="submit" class="rn_SubmitButton" name="rnServiceRequestSearchButton" id="rn_<?=$this->instanceID;?>_SubmitButton" <?=tabIndex($this->data['attrs']['tabindex'], 1);?> value="<?=$this->data['attrs']['label_button'];?>" />
    <? endif;?>
    <? if($this->data['isIE']): ?>
