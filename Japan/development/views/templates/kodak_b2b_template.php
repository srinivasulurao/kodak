...
for(var i=0; i<l.length; i++) {
  if   (l[i].href.indexOf("file=") > 0) {
			   //alert ('there is download manager link on this page');
					   document.write('<p><a target="_blank" href="/app/answers/detail/a_id/67746">ダウンロードに問題がある場合は…</a></p>');
					   break;
					   }
					   }
 					</script>
...
.rn_Multiline2 .rn_Element1{
 ...
 <?
  ...
  ?>
   ...
   <script> 
    var acl = '<?php echo $answer_access_level;?>';
...
<!--[if gte IE 7]>
<style type="text/css">
#rn_SideBar .rn_SimpleSearch .rn_SearchField {
    border: 0px none;
    color: #222;
    font-weight: bold;
    height: 1.8em;
...
#rn_SideBar button {
    background: #FFB700 url(images/buttonGradientCombo.png) 0px 0px repeat-x;
