    ...
    <div class="rn_Padding">
        <form id="rn_QuestionSubmit" method="post" action="" onsubmit="return false;">
            ...
            <rn:condition logged_in="true">
                ...
                <rn:widget path="input/ProductCategoryInput" name="incidents.product"  required_lvl="1" label_required="is required" />
                <rn:widget path="input/ProductCategoryInput" name="incidents.Category"  data_type="categories" label_input="#rn:msg:CATEGORY_LBL#" label_nothing_selected="#rn:msg:SELECT_A_CATEGORY_LBL#" required_lvl="1" label_required="is required" />
