<rn:meta title="#rn:msg:FINISH_ACCOUNT_CREATION_CMD#" template="kodak_b2b_template_nologin.php" />
...
<div id="rn_PageContent">
    <div class="rn_Padding">
            <rn:widget path="login/ResetPassword" label_heading="#rn:msg:CREATE_A_USERNAME_AND_PASSWORD_CMD#" on_success_url="#rn:php:'/app/account/profile/msg/' . urlencode(getMessage(SUCC_ACTIVATED_ACCT_PLS_COMP_MSG))#" />    
</div>
</div>
