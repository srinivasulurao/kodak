...
<div id="rn_PageTitle" class="rn_QuestionList">
    <div id="rn_SearchControls">
        ...
        <form method="post" action="" onsubmit="return false" >
                ...
                <rn:widget path="search/KeywordText" label_text="#rn:msg:SEARCH_YOUR_SUPPORT_HISTORY_CMD#" report_id="159" initial_focus="true"/>
                </div>
                <rn:widget path="search/SearchButton" report_id="159"/>
        </form>
...
<div id="rn_PageContent" class="rn_QuestionList">
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/ResultInfo" report_id="159" add_params_to_url="p,c"/>
        <rn:widget path="reports/Grid" label_caption="#rn:msg:SUPPORT_HISTORY_LBL#" report_id="159"/>
