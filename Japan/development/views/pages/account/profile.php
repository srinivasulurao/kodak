...
<!--                <rn:widget path="input/FormInput" name="contacts.login" required="true" validate_on_blur="true" initial_focus="true"/> -->
            ...
            <h2><? echo $templ_msg_base_array['lbl_search_preferences']; ?></h2>
            <fieldset>
            <legend><? echo $templ_msg_base_array['lbl_search_preferences']; ?></legend>
<rn:widget path="input/ProductCategoryInput" name="incidents.product"  data_type="products" label="#rn:msg:PROD_LBL#" />

<rn:widget path="input/ProductCategoryInput" name="incidents.Category"  data_type="categories" label_input="#rn:msg:CATEGORY_LBL#" label_nothing_selected="#rn:msg:SELECT_A_CATEGORY_LBL#"/>
