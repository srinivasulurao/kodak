...
<rn:widget path="knowledgebase/RssIcon" icon_path="" />
...
<div style="float:right; padding: 25px 80px 0px 0px;">                          <a class="rn_SearchLink"  href="javascript:void(0);" onclick="window.open('/app/utils/help_search', '', 'scrollbars,resizable,width=720,height=700'); return false;">#rn:msg:SEARCH_TIPS_LBL#</a></div>
                ...
                <rn:widget path="custom/search/SearchButtonOnChange" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#"/>
            </form>
...
<div id="rn_PageContent" class="rn_AnswerList">
    <div class="rn_Padding">
        ...
        <rn:widget path="reports/ResultInfo" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#" add_params_to_url="p,c"/>
        <rn:widget path="knowledgebase/TopicWords"/>
        <rn:widget path="reports/Multiline" report_id="#rn:php:$templ_msg_base_array['portal_report_id']#"/>
