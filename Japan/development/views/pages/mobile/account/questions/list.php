...
<section id="rn_PageTitle" class="rn_QuestionList">
    <div id="rn_SearchControls">
        ...
        <form method="post" action="" onsubmit="return false">
            <rn:widget path="search/KeywordText" label_text="" report_id="196" initial_focus="true"/>
            <rn:widget path="search/SearchButton" report_id="196" icon_path="images/icons/search.png"/>
        </form>
    </div>
</section>
<section id="rn_PageContent" class="rn_QuestionList">
    <div class="rn_Padding">
        <rn:widget path="reports/ResultInfo" report_id="196" add_params_to_url="p,c"/>
