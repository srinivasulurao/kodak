...
class CustomLoginDialog extends \RightNow\Libraries\Widget\Base {
    ...
    function getData() {
        ...
        //$this->data['attrs']['label_username']= Config::getMessage(LABEL_DISPLAY_USERNAME_BOX_LBL); 
        //$this->data['attrs']['label_dialog_title']= Config::getMessage(LABEL_DISPLAY_DIALOG_TITLE_LBL);
