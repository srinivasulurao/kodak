...
function load_array($file_name = null){
 ...
 // $file_path = '/cgi-bin/kodak_b2b_en.cfg/scripts/cp/customer/development/data/'.$file_name;
   //  $file_path = '/cgi-bin/kodak_b2b_en.cfg/scripts/custom/oracle/'.$file_name;
 
 //$file_path = "/www/rnt/kodak_b2b__pro/vhosts/kodak_b2b_en/euf/assets/csv/".$file_name;
